...
function Formulario(props) {
  ...
  const addItem = (e, actionCreator, type) => {
    e.preventDefault();
    dispatch(
      actionCreator({
        type: type,
  ...
  return (
    <Form>
      ...
      <Button variant="primary" className="mb-3" onClick={(e) => addItem(e, addGoal, 'GOAL')} type="submit">
        Add Goal
      </Button>
      <Button variant="primary" onClick={(e) => addItem(e, addTask, 'TASK')} type="submit" className="mx-3 mb-3">
        Add Task
      </Button>
      </div>
    </Form>
